...
const PopularCities = () => {
  ...
  return (
    <div className="wrapper w-full h-full py-20">
      <h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans mb-10">
        Discover the World’s Most Popular Cities
      </h2>
        ...
        >
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto mb-4">
            <span className="font-bold text-neutral-700 dark:text-neutral-200">
              The first rule of Apple Club is that you talk about Apple Club.
            </span>{" "}
            Keep a journal, jot down your travel ideas, and capture your dream
            destinations. Your personal travel guide is ready to inspire you.
          </p>
          <img
